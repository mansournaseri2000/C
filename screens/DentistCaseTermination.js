...
const DentistCaseTermination = () => {
  const navigation = useNavigation();

  return (
    <View style={[styles.dentistcasetermination, styles.containerFlexBox]}>
        ...
        <View style={[styles.bottombtn, styles.growtextbuttonSpaceBlock]}>
          ...
          <View style={styles.underbtntext}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              onPress={() => navigation.navigate("DentistCaseTerminationPDF")}
            >
...
export default DentistCaseTermination;
