...
const DentistContractPDF = () => {
  const navigation = useNavigation();

  return (
    <View style={[styles.dentistcontractpdf, styles.containerFlexBox]}>
        ...
        <View style={[styles.bottombtn, styles.growtextbuttonSpaceBlock]}>
          ...
          <View style={[styles.underbtntext, styles.underbtntextFlexBox]}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              onPress={() => navigation.navigate("DentistContract")}
            >
...
export default DentistContractPDF;
