  ...
  return (
    ...
    <View style={styles.dentistregister}>
      ...
      <View style={styles.topsection}>
        ...
        />
        <EntryPagesTitle pageTitle={'Patient Login'} />
      ...
      <View style={styles.bottomsection}>
        <PrimaryBtn buttonText="Login" goTo={'CaseProfile'} />
        <UnderBtnText inofText="Create your account?" pageName="Register" goTo={'CaseRegister'} />
      </View>
    </View>
  </Container>
  );
