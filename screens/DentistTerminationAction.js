...
const DentistTerminationAction = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.dentistterminationaction}>
      ...
      <View style={styles.container}>
        <View style={[styles.header, styles.headerSpaceBlock]}>
          ...
          <View style={[styles.header1, styles.header1SpaceBlock]}>
            <Text style={styles.headertext}>Case List</Text>
          </View>
          <Image
          ...
          <View style={[styles.casecard, styles.casecardBg]}>
            ...
            <View style={styles.infowrapper}>
              ...
              <View style={styles.detailwrapper}>
                ...
                <TouchableOpacity
                  style={[styles.actions, styles.actionsFlexBox]}
                  activeOpacity={0.8}
...
export default DentistTerminationAction;
