...
const DentistFinishedList = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.dentistfinishedlist}>
            ...
            <View style={styles.infowrapper}>
              ...
              <View style={styles.detailwrapper}>
                <View style={styles.detailwrapper1}>
                  <Text style={[styles.caseorder, styles.caseorderTypo]}>
                    +989126030028
                  </Text>
                </View>
                <View style={[styles.actions, styles.actionsFlexBox]}>
                  ...
                  >
                    <Text
                      style={[styles.ghostbuttontext, styles.caseorderTypo]}
                    >
                      05
                    </Text>
                  </Pressable>
                  ...
                  >
                    <Text style={[styles.buttontext, styles.caseorderTypo]}>
                      Login
                    </Text>
                  </Pressable>
                </View>
...
export default DentistFinishedList;
