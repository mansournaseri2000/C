...
const Case3DPaymentSuccess = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.case3dpaymentsuccess}>
      ...
      <View style={styles.container}>
        <View style={styles.maincontainer}>
          <View style={styles.header}>
            ...
            <View style={[styles.header1, styles.growtextbuttonWrapperFlexBox]}>
              <Text style={styles.headertext}>Simulation Payment</Text>
            </View>
            <Image
        ...
        <View style={styles.prfilecontainer}>
          <TouchableOpacity
            ...
            activeOpacity={0.2}
            onPress={() => navigation.navigate("CaseSimulationFirst")}
          >
...
export default Case3DPaymentSuccess;
