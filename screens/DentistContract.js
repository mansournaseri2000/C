...
const DentistContract = () => {
  const navigation = useNavigation();

  return (
    <View style={[styles.dentistcontract, styles.containerFlexBox]}>
        ...
        <View style={[styles.bottombtn, styles.growtextbuttonSpaceBlock]}>
          ...
          <View style={styles.underbtntext}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              onPress={() => navigation.navigate("DentistContractPDF")}
            >
...
export default DentistContract;
