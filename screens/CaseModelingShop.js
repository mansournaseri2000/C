...
const CaseModelingShop = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.casemodelingshop}>
        ...
        <View style={styles.maincontainer}>
          <View style={[styles.header, styles.headerSpaceBlock]}>
            ...
            <View style={[styles.header1, styles.header1SpaceBlock]}>
              <Text style={styles.headertext}>Modeling Kit</Text>
            </View>
            <Image
            ...
            <View style={[styles.profilecard, styles.bottomtabBg]}>
              <View style={styles.profileinfowrapper}>
                <View style={styles.profileinfowrapper1}>
                  ...
                  <View
                    style={[styles.greetingwrapper, styles.underbtntextFlexBox]}
                  >
...
`}</Text>
        ...
        <View style={[styles.prfilecontainer, styles.headerSpaceBlock]}>
          <TouchableOpacity
            ...
            activeOpacity={0.2}
            onPress={() => navigation.navigate("CaseModelingSuccess")}
          >
          ...
          <View style={[styles.underbtntext, styles.underbtntextFlexBox]}>
            ...
            >
              <Text style={[styles.trackModeling, styles.detailtextClr]}>
                Track modeling
              </Text>
            </TouchableOpacity>
          </View>
...
export default CaseModelingShop;
