...
const DentistCaseTerminationPDF = () => {
  const navigation = useNavigation();

  return (
    <View style={[styles.dentistcaseterminationpdf, styles.containerFlexBox]}>
      ...
      <View style={[styles.container, styles.containerFlexBox]}>
        <View style={styles.maincontainer}>
          <View style={styles.header}>
            ...
            <View style={styles.header1}>
              <Text style={styles.headertext}>Case Termination</Text>
            </View>
            <Image
        ...
        <View style={[styles.bottombtn, styles.growtextbuttonSpaceBlock]}>
          <TouchableOpacity
            ...
            activeOpacity={0.2}
            onPress={() => navigation.navigate("DentistTerminationAction")}
          >
          ...
          <View style={[styles.underbtntext, styles.underbtntextFlexBox]}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              onPress={() => navigation.navigate("DentistCaseTermination")}
            >
...
export default DentistCaseTerminationPDF;
