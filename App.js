      ...
      <NavigationContainer>
        {hideSplashScreen ? (
          <Stack.Navigator screenOptions={{headerShown: false}}>
            ...
            <Stack.Screen
              name="DentistReset"
              component={DentistReset}
              options={{headerShown: false}}
            />
            <Stack.Screen
              name="DentistRecovery"
              component={DentistRecovery}
              options={{headerShown: false}}
            />
            <Stack.Screen
              name="DentistHome"
            ...
            <Stack.Screen
              name="DentistIdentity"
              component={DentistIdentity}
              options={{headerShown: false}}
            />
            <Stack.Screen
              name="DentistContract"
              component={DentistContract}
              options={{headerShown: false}}
            />
            <Stack.Screen
              name="DentistContractPDF"
              component={DentistContractPDF}
              options={{headerShown: false}}
            />
            <Stack.Screen
              name="DentistTermination"
              component={DentistTermination}
              options={{headerShown: false}}
            />
            <Stack.Screen
              name="DentistTerminationPDF"
              component={DentistTerminationPDF}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="DentistDifferList"
              component={DentistDifferList}
              options={{headerShown: false}}
            />
            <Stack.Screen
              name="DentistPaymentSuccess"
              component={DentistPaymentSuccess}
              options={{headerShown: false}}
            />
            <Stack.Screen
              name="DentistPaymentCancel"
              component={DentistPaymentCancel}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="DentistDiffAccept"
              component={DentistDiffAccept}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="DentistDiffAcceptPdf"
              component={DentistDiffAcceptPdf}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="DentistGuaranteeList"
              component={DentistGuaranteeList}
              options={{headerShown: false}}
            /> 

            <Stack.Screen
              name="DentistCases"
              component={DentistCases}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="DentistNewCases"
              component={DentistNewCases}
              options={{headerShown: false}}
            />  

            <Stack.Screen
              name="DentistTreatmentList"
              component={DentistTreatmentList}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="DentistFinishedList"
              component={DentistFinishedList}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="DentistRefinementList"
              component={DentistRefinementList}
              options={{headerShown: false}}
            /> 

            <Stack.Screen
              name="DentistArchiveList"
              component={DentistArchiveList}
              options={{headerShown: false}}
            /> 
            <Stack.Screen
              name="DentistReturnList"
              component={DentistReturnList}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="DentistNewReturn"
              component={DentistNewReturn}
              options={{headerShown: false}}
            /> 

            <Stack.Screen
              name="DentistOrderList"
              component={DentistOrderList}
              options={{headerShown: false}}
            /> 

            <Stack.Screen
              name="DentistTerminationAction"
              component={DentistTerminationAction}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="DentistCaseTermination"
              component={DentistCaseTermination}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="DentistCaseTerminationPDF"
              component={DentistCaseTerminationPDF}
              options={{headerShown: false}}
            />
            ...
            <Stack.Screen
              name="CaseIdentity"
              component={CaseIdentity}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseModelingShop"
              component={CaseModelingShop}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseModelingSuccess"
              component={CaseModelingSuccess}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseModelingCancel"
              component={CaseModelingCancel}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseModelingInstruction"
              component={CaseModelingInstruction}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseModelingTrack"
              component={CaseModelingTrack}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseImperssion"
              component={CaseImperssion}
              options={{headerShown: false}}
            /> 

            <Stack.Screen
              name="CaseMedical"
              component={CaseMedical}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseSutable"
              component={CaseSutable}
              options={{headerShown: false}}
            />  

            <Stack.Screen
              name="CaseDoctorOpinion"
              component={CaseDoctorOpinion}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseOrderMethods"
              component={CaseOrderMethods}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="Case3DPaymentSuccess"
              component={Case3DPaymentSuccess}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="Case3DPaymentCancel"
              component={Case3DPaymentCancel}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseSimulationFirst"
              component={CaseSimulationFirst}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseShopDisable"
              component={CaseShopDisable}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseShopDetail"
              component={CaseShopDetail}
              options={{headerShown: false}}
            />
            <Stack.Screen
              name="CaseAlignerPaymentSuccess"
              component={CaseAlignerPaymentSuccess}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseAlignerPaymentCancel"
              component={CaseAlignerPaymentCancel}
              options={{headerShown: false}}
            />
            ...
            />
            <Stack.Screen
              name="CaseContractPDF"
              component={CaseContractPDF}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseSimulationSecond"
              component={CaseSimulationSecond}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseTrackAligner"
              component={CaseTrackAligner}
              options={{headerShown: false}}
            />

            <Stack.Screen
              name="CaseTrackStructure"
              component={CaseTrackStructure}
              options={{headerShown: false}}
            />
